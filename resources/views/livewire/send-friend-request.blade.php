<form wire:submit.prevent="submitSendFriendRequest">
    <div class="modal-body py-0">
        <div class="profile modal-gx-n">
            ...
            <div class="profile-body">
                ...
                <h4 class="fw-bold mb-1">Отправить заявку в друзья</h4>
                <p style="font-size: 16px;">Отправьте пригласительные ссылки своим друзьям</p>
            </div>
        </div>
        ...
        <div class="modal-py">
            <div class="col-12">
                <input type="text" class="form-control form-control-lg"  name="SendFriendRequestUsername" wire:model="SendFriendRequestUsername" placeholder="Ник пользователя" required>
            </div>
        </div>
        ...
        <div class="modal-py">
            <button type="submit"  class="btn btn-lg btn-primary w-100 d-flex align-items-center">
                ОТПРАВИТЬ ЗАПРОС
                <span class="ms-auto">
                    <svg wire:target="submitSendFriendRequest" wire:loading.remove xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                    <div wire:loading wire:target="submitSendFriendRequest" class="spinner-border spinner-border-sm" role="status">
