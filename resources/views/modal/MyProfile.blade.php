            ...
            <div class="modal-body py-0">
                ...
                <div class="profile modal-gx-n">
                    ...
                    <div class="profile-body">
                        ...
                        <h4 class="mb-1">{{\App\Http\Controllers\AccountCoreInfoController::getUserName(session()->get('tokenSession'))}}</h4>
                        <p>5 минут назад</p>
                    </div>
                </div>
                <!-- Header -->
                        ...
                        <div class="row align-items-center gx-6">
                            <div class="col">
                                ...
                                @if(\App\Http\Controllers\AccountCoreInfoController::getAccountLocation(session()->get('tokenSession')) != null)
                                    <p>{{\App\Http\Controllers\AccountCoreInfoController::getAccountLocation(session()->get('tokenSession'))}}</p>
                                @else
                                    <p>Нет информации</p>
                                @endif
                            </div>
                        ...
                        <div class="row align-items-center gx-6">
                            <div class="col">
                                ...
                                @if(\App\Http\Controllers\AccountCoreInfoController::getAccountPhone(session()->get('tokenSession')) != null)
                                    <p>{{\App\Http\Controllers\AccountCoreInfoController::getAccountPhone(session()->get('tokenSession'))}}</p>
                                @else
                                    <p>Нет информации</p>
                                @endif
                            </div>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row align-items-center gx-6">
                            <div class="col">
                                <h5>Активный статус</h5>
                                <p>Показывать, когда вы активны</p>
                            </div>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <a href="{{url('/logout')}}" class="text-danger">Выйти из аккаунта</a>
                    </li>
                </ul>
                <!-- List -->
            </div>
